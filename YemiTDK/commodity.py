...
def process_mitsui_data(train_path, test_path, train_labels_path, target_pairs_path):
    ...
    test_df = pd.read_csv(
        r"C:\Users\ayemi\OneDrive\Documents\Commodity_Prediction\mitsui-commodity-prediction-challenge\test.csv"
    )
    train_labels = pd.read_csv(
        r"C:\Users\ayemi\OneDrive\Documents\Commodity_Prediction\mitsui-commodity-prediction-challenge\train_labels.csv"
    )
...
if __name__ == "__main__":
    ...
    tests_csv = pd.read_csv(
        r"C:\Users\ayemi\OneDrive\Documents\Commodity_Prediction\mitsui-commodity-prediction-challenge\test.csv"
    )
    train_labels_csv = pd.read_csv(
        r"C:\Users\ayemi\OneDrive\Documents\Commodity_Prediction\mitsui-commodity-prediction-challenge\train_labels.csv"
    )
    target_pairs_csv = pd.read_csv(
        r"C:\Users\ayemi\OneDrive\Documents\Commodity_Prediction\mitsui-commodity-prediction-challenge\target_pairs.csv"
    )
